                ...
                for word in lines
                    ...
                    if arg1.strip("Arg1:") in lines and arg2.strip("Arg2:") in lines:
                        ...
                        if relation == "Relation" or relation == "RElation":
                            ...
                            sub_line1.extend(lines)
                            sub_line1[arg1_pos] = "entity1"
                            sub_line1[arg2_pos] = "entity2"
                            ls.append(sub_line1)
                            label_list.append(relation)

                            #entity入れ替え
                            sub_line1_rev =[]
                            sub_line1_rev.extend(lines)
                            sub_line1[arg2_pos] = "entity1"
                            sub_line1[arg1_pos] = "entity2"

                            ls.append(sub_line1_rev)
                            label_list.append(relation)
